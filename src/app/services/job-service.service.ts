...
export class JobServiceService {
  ...
  response = {
    jobsfeed: [
      ...
      },
      {
        ...
        applylink:
          "https://dare2compete.com/o/college-ambassador-of-e-cell-iit-bombay-61622",
        jd:
      ...
      },
      {
        ...
        jd:
          "We are seeking for HR Intern for 2-3 months working as a valuable member of HR Team. You will gain an understanding of how the recruitment process works in an organization and what it takes to excel.",
        companyname: "",
        location: "",
        experience: "",
        salary: "",
      ...
      },
      {
        ...
        jd:
          "We're looking for someone to hustle with us and shape our venture from the ground up. The selected intern will get an opportunity to learn from experienced founders and tech professionals.",
        companyname: "",
        location: "",
        experience: "",
        salary: "",
      ...
      },
      {
        ...
        title: "Operations",
        applylink:
          "https://internshala.com/internship/detail/operations-internship-in-bangalore-at-oncocom1532334735",
        jd: "",
      ...
      },
      {
        ...
        applylink:
          "https://www.shine.com/jobs/Sales-Executive/Amprovit-Technologies-pvt.ltd/9296137",
        jd:
          "Dear Candidate, IMMEDIATE HIRING FOR Sales Executive Hereby we would like to invite you for attending the interview in our office as mentioned below. Interview Time:- 10.30 am 1.30 pm",
        ...
        type: "",
        skills:
          "industry, sales, reports, state, organization, quality, support, benchmarking,b2c sales, direct sales, field sales",
      ...
      },
      {
        ...
        applylink:
          "https://www.freshersworld.com/jobs/m-tech-freshers-jobs-in-thiruvananthapuram-suntec-business-solutions-pvt-ltd-technopark-370283",
        jd:
          "Ltd. Technopark - Thiruvananthapuram. Job Title: Hiring of M-tech FreshersCompany: SunTec Business Solutions Pvt. Ltd.Location: Technopark,...",
      ...
      },
      {
        ...
        applylink:
          "https://internshala.com/internship/detail/internet-of-things-iot-internship-in-bangalore-at-k2farms-private-limited1536686896",
        jd: "",
      ...
      },
      {
        ...
        jd:
          "We are seeking a Digital marketer who will get the chance to work on a large-scale pan-India marketing campaign across multiple media.This is the platform where candidate will have an immense exposure in marketing.",
        companyname: "",
        location: "Mumbai",
        experience: "",
        salary: "",
      ...
      },
      {
        ...
        applylink:
          "https://dare2compete.com/o/campus-ambassador-programme-67183",
        jd:
          "We are looking for a candidate who will help us plan, execute and optimize our marketing campaigns in their respective colleges and bring more volunteers. You will work and collaborate with senior members to track and measure performance, and provide result for all efforts.",
        companyname: "",
      ...
      },
      {
        ...
        applylink:
          "https://dare2compete.com/o/planet-green-internship-business-development-67179",
        jd:
          "We are looking for interns who have good communication and convincing skills who can converse people with ease, use their network and contacts and convert leads. The stipend is based on the number of converted leads. There is no limit on how much one can earn.",
        companyname: "",
        location: "Hyderabad",
        experience: "",
        salary: "",
      ...
      },
      {
        ...
        applylink:
          "https://dare2compete.com/o/business-development-and-salesadmin-67294",
        jd:
          "We are seeking a administration executive, who will us plan , execute, optimize our marketing channels,You will work independently and explore different areas of marketing and development , a best opportunity to upgrade your skills with opportunities to serve .",
        companyname: "",
        location: "New Delhi",
        experience: "",
        salary: "",
      ...
      },
      {
        ...
        applylink:
          "https://internshala.com/internship/detail/content-writing-tennis-internship-in-bangalore-at-sportskeeda1536401512",
        jd: "",
      ...
      },
      {
        ...
        applylink:
          "https://internshala.com/internship/detail/business-analytics-internship-in-bangalore-at-xiaomi-technology-india-private-limited1536074239",
        jd: "",
      ...
      },
      {
        ...
        applylink:
          "https://internshala.com/internship/detail/content-writing-internship-in-bangalore-at-sportskeeda1535978906",
        jd: "",
        companyname: "Sportskeeda",
        location: "Bengaluru",
        experience: "Fresher",
      ...
      },
      {
        ...
        applylink:
          "https://internshala.com/internship/detail/human-resources-hr-internship-in-bangalore-at-aditya-birla-fashion-retail-limited1535700644",
        jd: "",
  ...
  constructor() {
    ...
    this.filteredJobs = this.response.jobsfeed;
  }

  
  
  getLocations_Experience() {
    const locations = [];
    const experience = [];
    this.response.jobsfeed.forEach((job: any) => {
      if (job.location != "") {
        locations.push(job.location);
      }
      if (job.experience != "") {
        experience.push(job.experience);
      }
      if (job.experience == "") {
        experience.push('Not Specified');
      }
      

    });
    var uniqueLocations = locations.reduce((accumulator, currentValue) => {
    ...
    var uniqueExperience = experience.reduce((accumulator, currentValue) => {
      if (currentValue != '' && accumulator.indexOf(currentValue) === -1) {
        accumulator.push(currentValue);
      }
      return accumulator;
    }, []);
    return { locations: uniqueLocations, experience: uniqueExperience };
  }

  getFilteredJobs(location,experience){
    var filteredArrray = this.response.jobsfeed.filter( job => (job.location.indexOf(location) != -1 && job.experience.indexOf(experience) != -1));  

    if(experience === 'Not Specified'){
      filteredArrray = this.response.jobsfeed.filter( job => (job.location.indexOf(location) != -1 && job.experience.indexOf('') != -1));  
    }else{
      filteredArrray = this.response.jobsfeed.filter( job => (job.location.indexOf(location) != -1 && job.experience.indexOf(experience) != -1));  
    }
    this.filteredJobs =  filteredArrray;
    return this.filteredJobs;
  //   alert(JSON.stringify(this.filteredJobs))
  //  console.log("filter Jobs : ", this.filteredJobs);
  }
